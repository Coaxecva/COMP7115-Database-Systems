...
<div class="menu">
	<div class="menuleft">
		<strong>List</strong>
		<ul>
			<li><a href="/admin/historyshop"><p>Tất cả</p></a></li>
			<li><a href="/admin/bought"><p>Khách hàng đã thanh toán</p></a></li>
			<li><a href="/admin/check"><p>Đã giao</p></a></li>
		</ul>
	...
	<table border = "1">
		@foreach($list as $lists)
				...
				<tr>
					<th colspan="7">Địa chỉ :{{$lists->diachi}}</th>
				</tr>
		@endforeach
